...
public class HibernateCategoryDao implements CategoryDao {
	...
	public void add(Category category) {
		...
		System.out.println("Kategori: " + category.getName() + " sisteme eklendi.(Hibernate)");

	}

	@Override
	public void update(Category category) {
		System.out.println("Kategori: " + category.getName() + " güncellendi.(Hibernate)");

	}

	@Override
	public void delete(String id) {
		System.out.println("Kategori sistemden kaldırıldı.(Hibernate)");
